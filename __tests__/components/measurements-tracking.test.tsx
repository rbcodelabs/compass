...
vi.mock("@/app/[orgSlug]/[workspaceSlug]/settings/analytics-actions", () => ({ readMeasurements: mocks.read, listAnalyticsMetrics: mocks.metrics, linkAnalyticsMetric: mocks.link, updateAnalyticsMeasurement: mocks.update, refreshAnalyticsMeasurement: mocks.refresh }));
