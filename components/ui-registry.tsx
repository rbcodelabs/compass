          ...
          <div className="space-y-12">
            <Section id="tokens" title="Semantic tokens" description="Product code should choose a role from this vocabulary instead of a literal palette value.">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <Example title="Text roles"><div className="space-y-2 text-sm"><p className="font-medium text-text-primary">Primary text</p><p className="text-text-secondary">Secondary text supports the main hierarchy.</p><p className="text-text-subtle">Subtle text is for quiet metadata.</p><p className="text-text-disabled">Disabled text is intentionally de-emphasized.</p><p className="rounded-lg bg-foreground p-2 text-text-inverse">Inverse text on an inverted surface</p></div></Example>
            ...
            <Section id="typography" title="Typography" description="Inter is the default; workspace branding may replace the sans role without changing hierarchy.">
