...
export function PmInterviewHistory({ orgSlug, workspaceSlug, interviews = [] }: { orgSlug: string; workspaceSlug: string; interviews?: Array<{ id: string; disposition: string; generationState: string; createdAt: string | Date }> }) {
