    ...
    <>
      {compact ? (
        <button
          ...
          className="flex flex-col items-center justify-center w-14 h-10 rounded-lg gap-0.5 text-text-subtle hover:bg-surface-interactive-hover hover:text-text-primary transition-colors"
        ...
        <button
          type="button"
          onClick={() => setOpen(true)}
          className="relative flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-left text-sm font-medium text-text-subtle transition-all duration-150 hover:bg-surface-interactive-hover hover:text-text-primary"
        >
